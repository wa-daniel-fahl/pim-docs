...
- to be registered your configuration file should be named ``form_extensions.yml`` or putted in a ``form_extensions`` folder in your bundle ``Resources/config`` folder.
